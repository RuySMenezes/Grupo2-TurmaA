...
public class Intro {
	...
	// static int u=0;
	// 70, 150, 25
	static int temp_dialog = 0, temp_narrativa = 00, temp_transicao = 0; // Para rodar o jogo sem o delay nas mensagens,
																			// pode mudar o valor destas 3 variÃ¡veis
																			// para 0;
	...
	static void menu() throws Exception { // metodo para puxar as escolhas do menu
		String escolha_menu;
		System.out.println("\n1 - Jogar\n2 - InstruÃ§Ãµes\n3 - CrÃ©ditos\n4 - Sair");
		escolha_menu = entrada.next(); 	/* string para caso alguÃ©m digitar uma opÃ§Ã£o diferente de int o que farÃ¡
										  bugar a execuÃ§Ã£o do cÃ³digo. */
...
//USAR SUPER AND SUBCLASSES. Inserir tudo em um sÃ³, dependendo da escolha do jogador.
	static void jogo() throws InterruptedException { // metodo de inicio do jogo
		...
		String escolha;
			Digita("\n[MESTRE]: O ano Ã© 2018."
				+ "\n[MESTRE]: Toninho finaliza seu dia de trabalho. Entra em seu seu Ford Belina e dÃ¡ partida no motor.\n"
		...
		do {
			...
			case "1":
				Digita("\nCleytinho: AEHOOOO, hoje o couro vai cochar!\n"
						...
						+ "\n[MESTRE]: Toninho continua desmaiado e dormindo como se nÃ£o houvesse o amanhÃ£.",
						TimeUnit.MILLISECONDS, temp_dialog);
				break;
			case "2":
				Digita("\nCleytinho: Sai dessa, homi! Eu sei que vocÃª vai voltar para casa e ficar ligando pra Lucilene.\r\n"
						...
						+ "BIP BIP BIP...\r\n" + "\n***Toninho desmaia apÃ³s chorar copiosamente***",
						TimeUnit.MILLISECONDS, temp_dialog);
				break;
			default:
				System.out.println("\nOpÃ§Ã£o invÃ¡lida!");
		...
		} while (!escolha.contentEquals("1") && !escolha.contentEquals("2"));
		...
		do {
			...
			case "1":
				...
				break;
			case "2":
				Digita("\nSheylla: VocÃª nÃ£o estÃ¡ na posiÃ§Ã£o de decidir coisa alguma, AntÃ´nio.",
						TimeUnit.MILLISECONDS, temp_dialog);
				break;
			default:
				System.out.println("\nOpÃ§Ã£o invÃ¡lida!");
		...
		} while (!escolha.contentEquals("1") && !escolha.contentEquals("2") && !escolha.contentEquals("3"));
		...
		do {
			...
			case "2":
				...
				/*
				 * if (D20 >= 1 && D20 <= 10) { Ele errarÃ¡ e provocarÃ¡ a irÃ¡ de Esfinge,
				 * caso em que o jogador perderÃ¡ 2 pontos de vida e Sheylla terÃ¡ de intervir
				 * para salvar Toninho. CulminarÃ¡ com uma luta intensa e a eventual morte da
				 * Esfinge. } else if (D20 > 10 & D20 <= 15) { A tijolada Ã© suficiente para
				 * nocautear a Esfinge temporariamente, permitindo a passagem de Sheylla e
				 * Toninho. } else if (D20 > 15) { A tijolada mata a Esfinge. }
				 */
			}
