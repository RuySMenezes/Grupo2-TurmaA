...
public class teste {
	...
	public static void desafioC3II() {
		 ...
		 * 
		 * Toninho come�a a ter alguns flashs de mem�ria e se lembra de quando estava no bar com seus amigos
		 ...
		 * 
		 * 
		 * se essse enrredo n�o ajudar a equa��o seria 2x +4x = 36 e o valor de 2.x � 12
		 * 
		 */
	...
	public static void desafioC3III() {
		...
		/*op��o para tenta encaixar no enrredo...
		 * 
		 * Mais uma lembran�a vem a tona quando Toninho p�e a m�o no bolso e retira um papel
		 * que parece ser um monte de c�digo escrito,
	...
	public static void desafioC3IV() {
		...
		do {
			...
			System.out.println("Pensando em formato de gr�fico,\n"
					+ "qual seria a posi��o de 'x' e 'y' quando Toninho estiver em cima do muro? ");
			System.out.println("a) " + r.get(0));
			System.out.println("b) " + r.get(1));
			System.out.println("c) " + r.get(2));
			System.out.println("d) " + r.get(3));
